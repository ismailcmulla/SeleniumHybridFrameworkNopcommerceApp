...
class AddCustomer:
    ...
    txtcustomerRoles_xpath = "//div[@class='input-group-append input-group-required']//div[@role='listbox']"   ####"//div[@class='k-multiselect-wrap k-floatwrap']"
    ...
    def setCustomer_Roles(self, role):
        ...
        if role == 'Registered':
            ...
            self.driver.find_element(By.XPATH, "//li[normalize-space()='Guests']").click()
